...
API_ID = int(environ['17545571'])
API_HASH = environ['d17df0ce9368925f8bc6aacf861b7c86']
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','mrrighteousdev') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','blastwallztv') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','mrrighteousdev') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','mrrighteousdev')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
lazy_groups = environ.get('LAZY_GROUPS','-1002265330483')
